...
use App\Models\Leitner;
use App\Models\Konkorq;
use App\Session;
use Carbon\Carbon;
...
class KonkorController extends Controller
{
    ...
    public function konkors()
    {
        ...
        return view('melisan.management.konkor.konkors', compact('konkors', 'user', 'content','mosabeghat','user2'));
    }
    ...
    public function enter(Request $request)
    {
        ...
        return view('melisan.management.konkor.enter',
         compact('course', 'question', 'box1', 'box5', 'box4', 'box3', 
         'box2', 'rand', 'todays_price', 'alls_price','user','mosabeghat','user2','content'));
    }
