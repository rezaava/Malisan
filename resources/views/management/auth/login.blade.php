...
{{--                                    <div class="radio-classic-danger">--}}
{{--                                        <label><input type="radio" name="role" value="2" checked>دانشجو</label>--}}
{{--                                    </div>--}}
{{--                                    <div class="radio-classic-danger">--}}
{{--                                        <label><input type="radio" value="1" name="role">استاد</label>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                <div class="row margin">
                                    <div class="input-field col s12">
                                        ...
                                        <label for="username" class="center-align">نام کاربری(کد ملی)</label>
                                    </div>
                                </div>
                                <div class="row margin">
                                    <div class="input-field col s12">
...
{{--                                </div>--}}
                                ...
                                <div class="row">
                                    <div class="input-field col s6 m6 l6">
                                        ...
                                        <p>
                                            شماره تماس جهت پشتیبانی :09203934677
                                        </p>
                                    </div>
{{--                                    <div class="input-field col s6 m6 l6">--}}
