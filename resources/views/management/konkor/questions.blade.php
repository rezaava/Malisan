    ...
    <div id="content" class="main-content">
        ...
        <div class="layout-px-spacing" style="margin-bottom: -300px">
                ...
                @foreach($questions as $key=>$question)
                    <h3>
                        {{$question->question}}<span class="text-info" style="font-size: 14px">({{($question->year)}})</span>
                    </h3>
                        ...
                        <h6 @if($question->answer==4) class="text-success" @endif>
                            4.{{$question->answer4}}
<br>
                            <a href="/dashboard/konkor/question/edit/{{$question->id}}" class="btn btn-info">edit</a>
                            <a href="/dashboard/konkor/question/delete/{{$question->id}}" class="btn btn-danger">delete</a>
