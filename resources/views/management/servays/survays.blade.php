...
@section('main-content')
    <div class=" row">
        <div class="col 12 s12">
            ...
            <a href="/dashboard/export-students?cat_id={{$cat}}"
                class="mb-6 btn-floating waves-effect waves-light gradient-45deg-light-blue-cyan gradient-shadow tooltipped"
                data-position="bottom" data-tooltip="خروجی دانشجویی">
                <i class="material-icons dp48">person_pin</i>
                <i data-feather="edit"></i>
            </a>
                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        <div id="view-input-fields" class="active">
                            <div class="col s12">
                                <p>
                                    مدرس گرامی ! ابتدا فرم زیررا جهت درج نظرسنجی تکمیل نموده سپس در باکس نوع سوال یکی
                                    از گزینه های
                                ...
                                @else
                                    ...
                                    @if(isset($course))
                                    <input name="cat_id" value="{{$course->id}}" readonly>
                                    @else
                                        <input name="cat_id" value="{{$cat}}" readonly>
                                    @endif
                                    <div class="col s12">
