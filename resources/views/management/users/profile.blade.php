                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <form id="accountForm"  action="/dashboard/user/edit/{{$user->id}}"
                          method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col s12 m6">
                                                    <div class="row">
                                                        <div class="col s12 input-field">
                                                            <select name="gender" @if(!$edit) disabled @endif 
                                                                    class="form-control rtl">
                                                                <option @if (old('gender') == "") {{ 'selected' }} @endif value="">جنسیت رامشخص کنید</option>
                                                                @if(isset($user))
