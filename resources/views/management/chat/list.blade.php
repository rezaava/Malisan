...
@section('main-content')
     <div id="content" class="main-content" style="margin-bottom :40px">
                                            ...
                                            <form class="chat-form" id="form-id" action="/dashboard/chat" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <button class="ajaxLink btn btn-primary btn-block" type="submit">
                                                                ارسال
                                                            </button>
                                                        </div>
                                                        <input type="text" name="id"  id="text_id" style="display:none;width: 50px;height: 0px;COLOR:WHITE;font-family:arial"
                                                               class="form-control"
                                                        />
                                                        <input type="text" name="crs_id" style="width: 50px;display:none;height: 50px; COLOR:WHITE;font-family:arial"  id="crs_id"
                                                               class="form-control"
                                                        />
                                                    </div>
                                                </div>
