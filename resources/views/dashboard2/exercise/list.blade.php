...
@section('main')
    ...
    <div id="content" class="main-content">
        ...
        {{-- <li class="breadcrumb-item active" aria-current="page"><span>تکلیف</span></li> --}}
        {{-- </ol> --}}
        {{-- </nav> --}}
                                                    ...
                                                    <div class="form-group @if ($errors->has('text')) has-error @endif">
                                                        ...
                                                        @if (Laratrust::hasRole('student'))
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="col-lg-12">
                                                                    <textarea class="form-control btn-square editor"
                                                                        name="text" id="description{{ $key }}"
                                                        ...
                                                        @if ($question->answer)
                                                            @if ($question->answer->file)
                                                                <a href="{{ URL::to('/files/answer' . $question->answer->file) }}"
                                                                    target="_blank">
                                                                    دانلود
                                                                </a>
                                                            @endif
                                                ...
                                                <div class="form-group @if ($errors->has('question')) has-error @endif">
                                                    <div class="row">
                                                        <label>طرح سوال یا مساله به عنوان تکلیف برای دانشجو<span
                                                                style="color: red"> (در صورتیکه بیش از یک تکلیف میخواهید به
