        ...
        <nav  class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-purple-deep-orange gradient-shadow">
            <div class="nav-wrapper">
                <div class="header-search-wrapper hide-on-med-and-down"><i class="material-icons">search</i>
                    <input class="header-search-input z-depth-2 iransans" type="text" name="Search"
                        placeholder="جست و جو..." data-search="template-list">
                ...
                <ul class="navbar-list right">
                    ...
                    <li>
                        <a class="waves-effect waves-block waves-light sidenav-trigger" @if($user->hasRole('teacher'))
                        href="{{asset('/files/help.pdf')}}" @elseif($user->hasRole('student'))
                            href="{{asset('/files/help2.pdf')}}" @endif 
                            data-target="">
                    ...
                    <li>
                        <a class="waves-effect waves-block waves-light profile-button"
                            ...
                            <span class="avatar-status avatar-online">
                                <img src="{{ asset('/files/user/' . $user->image) }}" alt="avatar">
                            </span>
                        </a>
                    </li>
                    <li><a class="waves-effect waves-block waves-light sidenav-trigger"
                            href="/dashboard/user/{{auth()->user()->id}}">
                            <span class="avatar-status avatar-online">
                                <img src="{{ asset('/files/user/' . $user->image) }}" alt="avatar">
                                <i></i>
                            </span>
                    ...
                    <li>
                        <a class="waves-effect waves-block waves-light sidenav-trigger" href="/dashboard/chat">
