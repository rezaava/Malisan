                            ...
                            <form class="col s12" action="@if(isset($course)){{'/dashboard/courses/edit/'.$course->id}}@else{{'/dashboard/courses/create'}}@endif" method="post">
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        ...
                                        <input id="name" name="name" required type="text" class="validate" value="@if(isset($course)){{$course->name}}@elseif($old){{$old->name}}@endif">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="majazi" name="majazi" type="text" class="validate" value="@if(isset($course)){{$course->majazi}}@elseif($old){{$old->majazi}}@endif">
                                        <label class="contact-input" for="icon_telephone">لینک کلاس مجازی (اختیاری)</label>
                                    </div>
                                    <div class="input-field col s6" hidden>
                                        <i class="material-icons dp48 prefix">link</i>
                                        <input id="majazi" name="copy" type="text" class="validate" value="@if($old) {{$old->id}} @else 0 @endif">
