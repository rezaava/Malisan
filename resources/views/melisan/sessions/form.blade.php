...
{{--                                  onkeypress="return event.keyCode != 13;"--}}
                            >
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        <i class="material-icons dp48 prefix">insert_link</i>
                                        <input id="aparat" name="aparat" type="text" class="validate"
                                               value="@if(isset($meeting)){{$meeting->aparat}}@endif">
                                        <label class="contact-input" for="aparat">
                                           لینک آپارات
                                           (اختیاری)(کد script آپارات را کپی کنید)
                                        </label>
                                    </div>
