...
Route::group(['namespace' => 'Auth'], function () {
    ...
    Route::post('/sendTokenToServer', [AuthController::class, 'sendTokenToServer']);
...
Route::post('/foo', [FooController::class, 'fooPost'])->name('foo.post');
Route::get("/", function () {
